...
'''
class AbstractMerityLanguageModel(AbstractLanguageModel):
...
'''
class TinyLanguageModel(AbstractMerityLanguageModel):
...
'''
class SmallLanguageModel(AbstractMerityLanguageModel):
...
'''
class LanguageModel(AbstractMerityLanguageModel):
